...
## Evaluation Results
The evaluation results for object removal, object replacement, and object re-texturing are available [here](https://drive.google.com/drive/folders/1D2t7rioAXalvTV453IBzez4aiq8tB7dC?usp=drive_link). You can download the data as a `.zip` file or browse the folders directly from the link.

## To-Do

- [x] Release paper.
- [x] [Release evaluation results](https://drive.google.com/drive/folders/1D2t7rioAXalvTV453IBzez4aiq8tB7dC?usp=drive_link).
- [ ] Release code.
